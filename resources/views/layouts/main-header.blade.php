<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        {{-- <?php
        //  $collection = App\Models\Setting::get() 
        //  ?>
        //  <?php
        ...
        {{-- <a class="navbar-brand brand-logo " href="{{ url('/dashboard') }}"><img src="{{URL::asset('attachments/logo/'.$setting['logo'])}}" alt=""></a> --}}
        {{-- <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/logo_icon.png') }}"
                alt=""></a> --}}
        
                <a class="navbar-brand brand-logo " href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/FINAL SMS LOGO.png') }}" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/logo_icon.png') }}"
                alt=""></a>
        ...
        <div class="btn-group mb-1">
            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             ...
             <img src="{{ URL::asset('assets/images/flags/SY.png') }}" alt="" >
              ...
              <img src="{{ URL::asset('assets/images/flags/KU.png') }}" alt="">
              @else
              {{ LaravelLocalization::getCurrentLocaleName() }}
                                    ...
                                    <form method="GET" action="{{ route('logout','parent') }}">
                                        @else
                                            <form method="GET" action="{{ route('logout','web') }}">
                                                ...
                                                @csrf
                                                <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="text-warning ti-share-alt"></i>{{ trans('main_trans.sign_out') }}</a>
                                            </form>
