    ...
    <ul class="nav navbar-nav side-menu " id="sidebarnav">
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Grades-menu">
                <div class="pull-left"><i class="ti-menu"></i><span
      ...
      <li>
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">{{trans('main_trans.Accounts_fees')}}</a> </li>
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('main_trans.Invoices')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('main_trans.Catches_Receipt')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{ trans('main_trans.Fee_exclusion') }}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{ trans('main_trans.receipts') }}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Attendance.index')}}">  {{trans('main_trans.student_menue')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{route('Questions.index')}}">{{ trans('main_trans.ques_list') }} </a> </li>
            </ul>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{ trans('main_trans.List_book') }} </a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('online_classes.index')}}">{{ trans('main_trans.zoom_online') }}</a> </li>
