...
@section('css')
    ...
    @section('title')
        {{ trans('main_trans.title_cl-page') }}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Filter_Classes') }}" method="POST">
                        ...
                        <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                            ...
                            <option value="" selected disabled>{{ trans('main_trans.Search_By_Grade') }}</option>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Name"
                                                                   class="mr-sm-2">{{ trans('main_trans.Name_class') }}
                                                                :</label>
                        ...
                        <form class=" row mb-30" action="{{ route('Classrooms.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                    <div data-repeater-list="List_Classes">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en"
                                                           class="mr-sm-2">{{ trans('main_trans.Name_Grade') }}
                                                        :</label>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="btn btn-primary" data-repeater-create type="button" value="{{ trans('main_trans.add_row') }}"/><br>
                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('delete_all') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        {{ trans('main_trans.Warning_class') }}
