 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title" >
                <div class="row">
                    <div class="col-sm-6" >
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">{{ trans('main_trans.welcom_to_you') }} : {{auth()->user()->Name_Father}}</h4>
                    </div><br><br>
                    <div class="col-sm-6">
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-4">
                                <a href="">
                                    <div class="card text-black">
                                        {{-- <img src="{{$son->images->filename}}"/> --}}
                                        <img src="{{URL::asset('assets/images/my_son.png')}}"/>
                                        <div class="card-body">
                                            <div class="text-center">
                                                <h5 style="font-family: 'Cairo', sans-serif"
                                                    class="card-title">{{$son->name}}</h5>
                                                <p class="text-muted mb-4">{{ trans('main_trans.Student_details') }}</p>
                                            </div>
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <span>{{ trans('main_trans.Name_Class') }}</span><span>{{$son->classroom->Name_Class}}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
