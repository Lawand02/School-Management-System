    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel"></h5>{{trans('main_trans.return_student')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Graduated.update','test')}}" method="post" autocomplete="off">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('main_trans.warning_graduate')}}</h5>
