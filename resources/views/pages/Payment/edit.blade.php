...
@section('css')
    @toastr_css
@section('title')
  {{ trans('main_trans.update_exchange_bond') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('main_trans.update_exchange_bond') }} : <label style="color: red">{{$payment_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ trans('main_trans.amount_fees') }} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ trans('main_trans.invoice_state') }} : <span class="text-danger">*</span></label>
