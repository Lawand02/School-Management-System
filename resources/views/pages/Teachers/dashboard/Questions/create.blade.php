                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ trans('main_trans.name_question') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ trans('main_trans.answer_ques') }}<span style="color: red; font-size: smaller"> يجب فصل بعلامه - بين الاسئلة</span> </label>
