                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{ trans('main_trans.teacher') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.update',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('main_trans.username_ar') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('main_trans.username_en') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <hr>
                                <button type="submit" class="btn btn-success">{{ trans('main_trans.Edit_data') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
