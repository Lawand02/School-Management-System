                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('main_trans.new_Quiz') }}</a><br><br>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            ...
                                                            <a href="{{route('quizzes.show',$quizze->id)}}"
                                                                class="btn btn-warning btn-sm" title="{{trans('main_trans.show_question')}}" role="button" aria-pressed="true"><i
                                                                     class="fa fa-binoculars"></i></a>

                                                                     <a href="{{route('student.quizze',$quizze->id)}}"
                                                                        class="btn btn-primary btn-sm" title="{{trans('main_trans.list_student_exam')}}" role="button" aria-pressed="true"><i
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{ trans('main_trans.delete_Quz') }}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{ trans('main_trans.warning_grade') }} {{$quizze->name}}</p>
