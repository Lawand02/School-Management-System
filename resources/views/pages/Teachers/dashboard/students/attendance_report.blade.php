        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('attendance.search') }}" autocomplete="off">
                    @csrf
                    <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{ trans('main_trans.search_info') }}</h6><br>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="card-body datepicker-form">
                            <div class="input-group" data-date-format="yyyy-mm-dd">
                                ...
                                <input class="form-control range-to date-picker-default" placeholder="{{trans('main_trans.End_Date')}}" type="text" required name="to">
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <tr>
                            ...
                            <th class="alert-success">{{trans('main_trans.name')}}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($student->attendence_status == 0)
                                        <span class="btn-danger">{{ trans('main_trans.at_Absence') }}</span>
                                    @else
                                        <span class="btn-success">{{ trans('main_trans.at_Presence') }}</span>
                                    @endif
                                </td>
                            </tr>
