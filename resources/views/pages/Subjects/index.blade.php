                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('subjects.create')}}" class="btn btn-primary btn-sm" role="button"
                                   aria-pressed="true">{{ trans('main_trans.add_sub') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('main_trans.name_subject') }}</th>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('main_trans.delete_sub') }}</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p> {{ trans('main_trans.warning_grade') }} {{$subject->name}}</p>
