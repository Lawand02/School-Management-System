                    ...
                    $this->app->bind('App\Repository\PaymentRepositoryInterface',
                      ...
                      $this->app->bind('App\Repository\AttendanceRepositoryInterface',
                       ...
                       $this->app->bind('App\Repository\SubjectRepositoryInterface',
                        ...
                        $this->app->bind('App\Repository\QuizzRepositoryInterface',
                         'App\Repository\QuizzRepository');

                         $this->app->bind('App\Repository\QuestionRepositoryInterface', 
                         'App\Repository\QuestionRepository');

                         $this->app->bind('App\Repository\LibraryRepositoryInterface', 
